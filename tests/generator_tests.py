...
from gan import DCGenerator, ResGenerator
...
class GeneratorTests(unittest.TestCase):
    ...
    def test_ResGenerator(self):
        ...
        art = generator(noise)
        self.assertEqual(art.shape, (self.BATCH_SIZE, generator.out_channels, noise.shape[2], noise.shape[3]))
